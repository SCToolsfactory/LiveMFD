...
namespace MFDstartLand
{
  public partial class UC_MFDstartLand : UserControl, IUC_MFD, IMfdSupport
  {
    /// <summary>
    /// MFD Panels behind code object
    /// </summary>
    private MFDstartLandBC m_mfd = new MFDstartLandBC( );
    ...
    private void UC_MFDstartLand_Load( object sender, EventArgs e )
    {

    }

    private void UC_MFDstartLand_Paint( object sender, PaintEventArgs e )
    {
      if ( this.Visible ) {
    ...
    private void UC_MFDstartLand_VisibleChanged( object sender, EventArgs e )
    {
